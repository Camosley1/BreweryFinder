...
INSERT INTO breweries (name, address, city, zipcode, phone_number, description, brewery_logo_url, website_url, user_id, hours)
VALUES('Eventide Brewing Co','1015 Grant St SE','Atlanta','30315-2014','4049074543','Eventide Brewing was formed out of friendship and a love of good beer.  Nathan, Haley, and Geoffrey all met at Georgia Southern, and later on began to experiment with homemade pickles, mustard, cheese, and  beer.','shorturl.at/xyBG4','https://www.eventidebrewing.com/',2,'M-T Closed W-F 4PM-10PM Sa 12PM-10PM Su 11PM-6PM');

INSERT INTO breweries (name, address, city, zipcode, phone_number, description, brewery_logo_url, website_url,  user_id,hours)
VALUES('Fire Maker Brewing Company','975 Chattahoochee Ave NW','Atlanta','30318','6787058777','Fire Maker Brewing Company is committed to people and the beers they want to drink. We exist to inspire others and celebrate their achievements. Our purpose is to Create a Spark through everything we do.','shorturl.at/wAZ78','https://www.firemakerbeer.com/',2,'M Closed T-T 8AM-10PM F-Sa 8AM-11:30PM Su 12PM-9PM');

INSERT INTO breweries (name, address, city, zipcode, phone_number, description, brewery_logo_url, website_url, user_id, hours)
VALUES('Gordon Biersch Brewery Restaurant - Atlanta','3242 Peachtree Rd NE','Atlanta','30305-2425','4042640253','Step inside our 40-seat tasting room and brewhouse � thoughtfully designed and constructed from reclaimed materials.','https://s3-media0.fl.yelpcdn.com/bphoto/BXYh9kA6vCVVZJ3mw3gMiA/258s.jpg','https://www.gordonbierschrestaurants.com/airport-locations',2,'T-F 4PM-10PM Sa 12PM-10PM Su 12PM-6PM';

INSERT INTO breweries (name, address, city, zipcode, phone_number, description, brewery_logo_url, website_url,  user_id,hours)
VALUES("Johnnie MacCracken's Celtic Firehouse Pub, Inc.",'15 Atlanta Street','Atlanta','30060-1985','7705907868','IT WAS HERE BEFORE YOU WERE BORN','shorturl.at/xSUWX','https://www.johnniemaccrackens.com/',2,'M 4PM-1AM T-W 11AM-1AM TH-St');
